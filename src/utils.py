...
def Get_clean_info():
    #This dataframe stored ids of echo marked as unnoisy
...
def Get_views_info():
    #This dataframe is for pairing the echo with different views
...
#used only if data augmentation is needed
